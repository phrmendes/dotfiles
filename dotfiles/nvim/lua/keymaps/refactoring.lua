return function(bufnr)
	...
	vim.keymap.set(
		...
		{ buffer = bufnr, desc = "Function", expr = true }
	)
	...
	vim.keymap.set(
		...
		{ buffer = bufnr, desc = "Function to file", expr = true }
	)
	...
	vim.keymap.set(
		...
		{ buffer = bufnr, desc = "Variable", expr = true }
	)
	...
	vim.keymap.set(
		...
		{ buffer = bufnr, desc = "Block", expr = true }
	)
	...
	vim.keymap.set(
		...
		{ buffer = bufnr, desc = "Block to file", expr = true }
	)
