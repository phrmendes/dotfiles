...
map("n", "<leader>.", function() require("utils").mini_pick_grep_word() end, { desc = "Files" })
...
map("n", "<leader>bb", function() require("utils").mini_pick_buffers() end, { desc = "List" })
...
map("n", "<leader>e", function() require("utils").mini_files_open() end, { desc = "Explorer" })
...
map("n", "<leader>la", function() require("utils").mini_visits_add_label() end, { desc = "Add" })
map("n", "<leader>ld", function() require("utils").mini_visits_remove_label() end, { desc = "Delete" })
...
map({ "n", "x" }, "<leader>gs", function() require("mini.git").show_at_cursor({ split = "horizontal" }) end, {
	desc = "Show at cursor",
})
