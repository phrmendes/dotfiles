...
vim.keymap.set("n", "<leader>la", function() helpers_mini.visits.add_label() end, { desc = "Add" })
vim.keymap.set("n", "<leader>ld", function() helpers_mini.visits.remove_label() end, { desc = "Delete" })
vim.keymap.set("n", "<leader>ll", function() MiniExtra.pickers.visit_labels() end, { desc = "List" })
