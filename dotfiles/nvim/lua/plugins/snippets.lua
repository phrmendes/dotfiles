...
local latex = {
	...
	parse_snippet({ trig = "smean", name = "sample mean" }, "\\bar{X}"),
	parse_snippet({ trig = "norm", name = "norm" }, "\\|$1\\|$0"),
	parse_snippet({ trig = "notin", name = "not in " }, "\\not\\in "),
	parse_snippet({ trig = "partial", name = "partial derivative" }, "\\frac{\\partial ${1:F}}{\\partial ${2:x}} $0"),
	...
	parse_snippet({ trig = "txt", name = "text" }, "\\text{$1}$0"),
