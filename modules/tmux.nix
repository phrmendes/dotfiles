  ...
  config = lib.mkIf config.tmux.enable {
    programs.tmux = {
      ...
      in ''
        ...
        bind -n C-S-Left  if -F "#{@pane-is-vim}" 'send-keys C-S-Left'  'resize-pane -L 3'
        bind -n C-S-Down  if -F "#{@pane-is-vim}" 'send-keys C-S-Down'  'resize-pane -D 3'
        bind -n C-S-Up    if -F "#{@pane-is-vim}" 'send-keys C-S-Up'    'resize-pane -U 3'
        bind -n C-S-Right if -F "#{@pane-is-vim}" 'send-keys C-S-Right' 'resize-pane -R 3'
