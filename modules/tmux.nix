        ...
        ''
          ...
          bind C-Space run-shell "${sesh} connect \"$(
            ${sesh} list --icons | ${fzf} --tmux 80%,70% \
              --color bg:${c.base00},bg+:${c.base01},fg:${c.base04},fg+:${c.base06},header:${c.base0D},hl:${c.base0D},hl+:${c.base0D},info:${c.base0A},marker:${c.base0C},pointer:${c.base0C},prompt:${c.base0A},spinner:${c.base0C} \
