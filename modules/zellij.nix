...
}:
{
  ...
  config = lib.mkIf config.zellij.enable {
    home.file.".local/share/zellij/plugins/vim-zellij-navigator.wasm".source =
      "${pkgs.vim-zellij-navigator}/share/zellij/plugins/vim-zellij-navigator.wasm";
    ...
    programs.zellij = {
      ...
      settings = {
        ...
        keybinds =
          let
            zellij-navigator = "file:/$HOME/.local/share/zellij/plugins/vim-zellij-navigator.wasm";
          in
          {
