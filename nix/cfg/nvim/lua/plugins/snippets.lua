...
local equation_snippets = {
	...
	parse_snippet({ trig = "<->", name = "left and right arrow", priority = 200 }, "\\leftrightarrow"),
	parse_snippet({ trig = "<<", name = "<<" }, "\\ll"),
	parse_snippet({ trig = "<=", name = "less than" }, "\\le "),
	parse_snippet({ trig = "<==", name = "implied by" }, "\\impliedby"),
	parse_snippet({ trig = "<=>", name = "iff" }, "\\iff"),
	parse_snippet({ trig = "==>", name = "implies" }, "\\implies"),
	parse_snippet({ trig = ">=", name = "greater than" }, "\\ge "),
	...
	parse_snippet({ trig = "cub", name = "cube ^3" }, "^3 "),
	parse_snippet({ trig = "cup", name = "union" }, "\\cup "),
	parse_snippet({ trig = "ddx", name = "d/dx" }, "\\frac{d${1:F}}{d${2:x}} $0"),
	parse_snippet({ trig = "delx", name = "partial" }, "\\frac{\\partial ${1:V}}{\\partial ${2:x}} $0"),
	parse_snippet({ trig = "dint", name = "integral" }, "\\int_{${1:-\\infty}}^{${2:\\infty}} ${3:${3:F}} $0"),
	...
	parse_snippet({ trig = "x", name = "times", priority = 100 }, "\\times "),
